        ...
        <div v-show="success" class="alert alert-success">{{ message }}</div>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card shadow mb-4">
                        <div
                            class="card-header py-3 d-flex flex-row align-items-center justify-content-bimagesetween"
                        >
...
console.log(product);
    ...
    mounted() {
        if (this.pro) {
            ...
            this.product_variant = [];
            Object.keys(this.pro.product_variants).forEach(key => {
                this.product_variant.push({
                    option: key,
                    tags: this.pro.product_variants[key]
                });
            })
            this.product_variant_prices = this.pro.pro_prices;
            // this.checkVariant();
